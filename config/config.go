...
var (
	...
	defaultPrivValBlsKeyName  = "priv_validator_bls_key.json"
	defaultPrivValRelayerName = "priv_validator_relayer.json"
	...
	defaultPrivValBlsKeyPath  = filepath.Join(defaultConfigDir, defaultPrivValBlsKeyName)
	defaultPrivValRelayerPath = filepath.Join(defaultConfigDir, defaultPrivValRelayerName)
...
type BaseConfig struct { //nolint: maligned
	...
	// Path to the JSON file containing the bls private key to use as a validator in the consensus protocol
	PrivValidatorBlsKey string `mapstructure:"priv_validator_bls_key_file"`

	// Path to the JSON file containing the relayer address to use as a validator in the consensus protocol
	PrivValidatorRelayer string `mapstructure:"priv_validator_relayer_file"`
...
func DefaultBaseConfig() BaseConfig {
	return BaseConfig{
		...
		PrivValidatorBlsKey:  defaultPrivValBlsKeyPath,
		PrivValidatorRelayer: defaultPrivValRelayerPath,
...
// PrivValidatorBlsKeyFile returns the full path to the priv_validator_bls_key.json file
func (cfg BaseConfig) PrivValidatorBlsKeyFile() string {
	return rootify(cfg.PrivValidatorBlsKey, cfg.RootDir)
}

// PrivValidatorRelayerFile returns the full path to the priv_validator_relayer.json file
func (cfg BaseConfig) PrivValidatorRelayerFile() string {
	return rootify(cfg.PrivValidatorRelayer, cfg.RootDir)
}
