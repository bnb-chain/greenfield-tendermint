...
func (m *Vote) GetEventHash() string {
	if m != nil {
		return m.EventHash
	}
	return ""
...
var fileDescriptor_546ebc6ebb4a65fe = []byte{
	...
	0xa4, 0x33, 0x12, 0x8b, 0x33, 0x24, 0x58, 0x14, 0x18, 0x35, 0x38, 0xa1, 0xd2, 0x1e, 0x89, 0xc5,
	0x19, 0x4a, 0x8e, 0x5c, 0xec, 0xbe, 0xa9, 0xc5, 0xc5, 0x89, 0xe9, 0xa9, 0x42, 0xfa, 0x5c, 0x2c,
	0x20, 0x37, 0x81, 0x2d, 0xe7, 0x36, 0x92, 0xd4, 0xc3, 0xe2, 0x56, 0x3d, 0x90, 0x43, 0x3d, 0x18,
	0x82, 0xc0, 0x0a, 0x9d, 0x58, 0xb9, 0x98, 0x8b, 0x4b, 0x73, 0x9d, 0x42, 0x4e, 0x3c, 0x92, 0x63,
	...
	0x3f, 0x57, 0x1f, 0x29, 0x68, 0x90, 0x98, 0xe0, 0x60, 0xd1, 0xc7, 0x12, 0x6c, 0x49, 0x6c, 0x60,
	0x29, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xbd, 0xd6, 0xde, 0x40, 0x54, 0x01, 0x00, 0x00,
}
...
func (m *Vote) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.EventHash = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
