...
// BlsPublicKey defines the bls key for use with Tendermint Validators
type BlsPublicKey struct {
	Bls12381 []byte `protobuf:"bytes,1,opt,name=bls12381,proto3" json:"bls12381,omitempty"`
}

func (m *BlsPublicKey) Reset()         { *m = BlsPublicKey{} }
func (m *BlsPublicKey) String() string { return proto.CompactTextString(m) }
func (*BlsPublicKey) ProtoMessage()    {}
func (*BlsPublicKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_cb048658b234868c, []int{1}
}
func (m *BlsPublicKey) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BlsPublicKey) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BlsPublicKey.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BlsPublicKey) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BlsPublicKey.Merge(m, src)
}
func (m *BlsPublicKey) XXX_Size() int {
	return m.Size()
}
func (m *BlsPublicKey) XXX_DiscardUnknown() {
	xxx_messageInfo_BlsPublicKey.DiscardUnknown(m)
}

var xxx_messageInfo_BlsPublicKey proto.InternalMessageInfo

func (m *BlsPublicKey) GetBls12381() []byte {
	if m != nil {
		return m.Bls12381
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*BlsPublicKey)(nil), "tendermint.crypto.BlsPublicKey")
}
...
var fileDescriptor_cb048658b234868c = []byte{
	...
	0xe2, 0xd2, 0x5c, 0x25, 0x13, 0x2e, 0x1e, 0xa7, 0x9c, 0x62, 0x64, 0xc3, 0x39, 0x92, 0x72, 0x8a,
	0x0d, 0x8d, 0x8c, 0x2d, 0x0c, 0x21, 0xa6, 0x07, 0xc1, 0xf9, 0x48, 0x9a, 0x83, 0x4e, 0x3c, 0x92,
	...
	0x39, 0x3f, 0x57, 0x1f, 0xc9, 0xef, 0x48, 0x4c, 0x88, 0xe7, 0x30, 0xc2, 0x25, 0x89, 0x0d, 0x2c,
	0x61, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x96, 0x75, 0x16, 0x9e, 0x33, 0x01, 0x00, 0x00,
}
...
func (this *BlsPublicKey) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
	...
	that1, ok := that.(*BlsPublicKey)
	if !ok {
		that2, ok := that.(BlsPublicKey)
		if ok {
			that1 = &that2
		} else {
			return 1
...
func (this *BlsPublicKey) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}
...
func (m *BlsPublicKey) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BlsPublicKey) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BlsPublicKey) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *BlsPublicKey) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BlsPublicKey) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BlsPublicKey: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BlsPublicKey: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Bls12381 = append(m.Bls12381[:0], dAtA[iNdEx:postIndex]...)
			if m.Bls12381 == nil {
				m.Bls12381 = []byte{}
			}
			iNdEx = postIndex
